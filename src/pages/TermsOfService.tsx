      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-300">
              If you have any questions about these Terms, please contact us at <a href="mailto:angelo@tryarxautomate.com" className="underline text-blue-400">angelo@tryarxautomate.com</a>.
            </p>
          </section>
        </div>
         {/* Last updated date */}
